...
const login = async (req, res) => {
    try {
        ...
        if(await bcrypt.compare(password, user.password)){                    //generate JWT, after password matching/comparing
            ...
            // it means that the cookie is accessible only through the HTTP protocol and cannot be accessed or modified using client-side scripts (e.g., JavaScript running in a web browser).
            // "tokken will be name of cookie"
